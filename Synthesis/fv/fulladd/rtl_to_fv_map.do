...
# Generated on: Mon Mar 17 15:22:15 IST 2025 (Mon Mar 17 09:52:15 UTC 2025)
...
set logfile fv/fulladd/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fulladd -revised fv_map
...
add_search_path . /home/user/cadence/GENUS211/tools.lnx86/lib/tech -library -both
...
elaborate_design -golden -root {fulladd} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fulladd/fv_map.v.gz
elaborate_design -revised -root {fulladd}
...
set_system_mode lec
write_compared_points noneq.compared_points.fulladd.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fulladd.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fulladd.rtl.fv_map.rpt
